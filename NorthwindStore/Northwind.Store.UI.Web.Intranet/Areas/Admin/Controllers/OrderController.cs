...
using Northwind.Store.UI.Web.Intranet.Areas.Admin.Extensions;
using Northwind.Store.UI.Web.Intranet.Areas.Admin.ViewModels;
namespace Northwind.Store.UI.Web.Intranet.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        // GET: Admin/Order
        public IActionResult Index(OrderIndexViewModel vm, int page)
        {
            ...
            //vm.Orders = _context.Orders.Where(p => p.OrderId.Equals(vm.Filter)).ToList();
            vm.Orders = _context.Orders.ToList();

            vm.PageCount = Math.Ceiling(vm.Orders.Count() / (double)ordersPerPage);

            vm.Orders = vm.Orders.OrderBy(p => p.OrderId).Skip(start).Take(ordersPerPage).ToList();
